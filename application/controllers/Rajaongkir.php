<!-- BAGIAN CONTROLL SETTING - 
	 v_setting(Setting) - ADMIN, 
	 v_cekout(Check Out Belanja) - PELANGGAN, 
	 m_admin -->
...
{
	private $api_key = '1874787026a425d03602960b9e689e7c'; // Kunci Koneksi Dengan Raja Ongkir 
	...
	{
		$id_kota_asal = $this->m_admin->data_setting()->lokasi; //Mengambil data lokasi pemilik toko
